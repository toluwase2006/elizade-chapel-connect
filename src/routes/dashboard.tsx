      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        <div className="mb-12 flex items-start gap-4">
          ...
          <div>
            ...
            <h1 className="mt-3 text-4xl font-medium text-navy sm:text-5xl">Publish Chapel updates.</h1>
        ...
        {notice ? <p className="mb-8 rounded-md border border-gold/40 bg-gold/10 px-4 py-3 text-sm font-medium text-navy" role="status">{notice}</p> : null}

        <div className="grid gap-6 lg:grid-cols-2">
          <section className="rounded-lg bg-card p-7 shadow-[0_12px_30px_-24px_var(--navy)] ring-1 ring-navy/5 sm:p-9">
            ...
            <form className="mt-7 grid gap-5" onSubmit={publishStudy}>
              <div className="grid gap-2"><Label htmlFor="study-day">Day</Label><select id="study-day" name="study-day" defaultValue="Sunday" className="h-10 rounded-md border border-input bg-background px-3 text-sm text-foreground"><option>Sunday</option><option>Tuesday</option><option>Thursday</option></select></div>
