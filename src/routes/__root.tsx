...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elizade University Chapel" },
      { name: "description", content: "A welcoming Christian community for students at Elizade University in Ilara-Mokin." },
      { name: "author", content: "Elizade University Chapel" },
      { property: "og:title", content: "Elizade University Chapel" },
      { property: "og:description", content: "A welcoming Christian community for students at Elizade University in Ilara-Mokin." },
